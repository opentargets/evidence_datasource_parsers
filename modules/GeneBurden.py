...
def main(az_binary_data: str, az_quant_data: str, regeneron_data: str, gwas_studies: str, spark_instance: SparkSession) -> DataFrame:
    """This module brings together and exports target/disease evidence generated by AzGeneBurden.py and RegeneronGeneBurdeb.py."""
...
if __name__ == "__main__":
    ...
    evd_df = main(az_binary_data=args.az_binary_data, az_quant_data=args.az_quant_data, regeneron_data=args.regeneron_data, gwas_studies=args.gwas_studies, spark_instance=spark)
