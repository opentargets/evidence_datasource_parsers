...
def main(
    az_binary_data: str, az_quant_data: str, az_trait_mappings:str, regeneron_data: str, gwas_studies: str, spark_instance: SparkSession
) -> DataFrame:
    """This module brings together and exports target/disease evidence generated by AzGeneBurden.py and RegeneronGeneBurdeb.py."""

    regeneron_evd = process_regeneron_gene_burden(regeneron_data, gwas_studies, spark_instance=spark_instance)
    az_evd = process_az_gene_burden(az_binary_data, az_quant_data, az_trait_mappings, spark_instance=spark_instance)
