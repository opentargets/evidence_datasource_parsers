...
def main(
    ...
    Args:
        ...
        pharmacogenetics: Input JSON containing the toxicogenomic evidence curated by ClinPGx.
...
def process_pharmacogenetics(
    ...
    pgkb_url_template = "https://www.ClinPGx.org/search?query="
    pgx_safety = (
        pgx_df
...
def get_parser():
    ...
    parser.add_argument(
        "--pharmacogenetics",
        help="Input JSON containing the toxicogenomic evidence curated by ClinPGx.",
        type=str,
        required=True,
    )
    parser.add_argument(
