...
class DepMapEssentiality:
    ...
    def __init__(
        ...
        self.essentials = (
            ...
            .join(essential_genes_df, on="targetSymbol", how="inner")
...
def get_depmap_essentials(
    spark: SparkSession, input_folder: str, tissue_mapping_url: str
) -> DataFrame:
    ...
    """
    depmap_essentials = DepMapEssentiality(spark, input_folder, tissue_mapping_url)
...
def main(
    ...
    gene_essentiality = [
        ...
        get_depmap_essentials(spark, depmap_input_folder, tissue_mapping_url).persist(),
