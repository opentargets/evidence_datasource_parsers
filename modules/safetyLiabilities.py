...
SAFETY_RISK_INFO = 'https://raw.githubusercontent.com/opentargets/curation/il-safety-curation/target_safety/experimental_toxicity.tsv'


def main(
    toxcast: str, output:str, adverse_events: str = ADVERSE_EVENTS_URL, safety_risk: str = SAFETY_RISK_INFO, log_file:str = None
):
    """
    This module puts together data from different sources that describe target safety liabilities.

    Args:
        adverse_events: Input table containing adverse events associated with targets that have been collected from relevant publications. Fetched from GitHub.
        safety_risk: Input table containing cardiovascular safety liabilities associated with targets that have been collected from relevant publications. Fetched from GitHub.
