...
class PseudobulkExpression:
    ...
    def spark(self):
        """
        Get the Spark session for this instance.
        """
    ...
    def __init__(self, h5ad_path, datasource_id, datatype_id, json):
    ...
    def main(self, args, agg_method):
        ...
        if args.normalise and agg_method == 'mean':
...
if __name__ == "__main__":
    ...
    p.add_argument(
        "--normalise", action='store_true', default=False,
        help="Apply normalisation to the data (logCP10K for mean aggregation, CPM for sum aggregation)."
        )
    p.add_argument(
